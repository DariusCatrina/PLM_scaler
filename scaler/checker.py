...
def run_scaler(size_in, size_out, dataset):
    ...
    xout_prime = scaler.step(xin=xin, xout=xout)
    print(r2_score(xout, scaler.predict_regressor(xin)))
...
if __name__ == '__main__':
    dataset = 'toy_set_10Kseqs'

    run_scaler('8M', '150M', dataset)
    run_scaler('150M', '650M', dataset)
    run_scaler('650M', '3B', dataset)
